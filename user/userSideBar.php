...
<body>
    ...
    <div class="userSideBar ">
        <header>Menu</header>
        <ul class="userSideBarUl">
            <li><a href="homePage.php" class="userSideBarLink"><i class="fas fa-home"></i>Khai Dai </a></li>
            <li><a href="profile.php" class="userSideBarLink"><i class="fas fa-user-edit"></i>Profile</a></li>
